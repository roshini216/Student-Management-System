        ...
        <div class="container">
	        <div id="login-box">
		        <div class="logo">
			        ...
			        <h1 class="logo-caption"><center> Login</center></h1>
		</div><!-- /.logo -->
		<div class="controls">
			<form method="POST">
	        ...
	        <div style ="width:50%;">  <a href = "./signup.jsp" >New User</a></div>
              <div style ="width:50%; text-align: right;font-family: Verdana, Geneva, Tahoma, sans-serif;">
              <%
