...
<html>
        ...
        <style>
            *{font-size:40px; 
            ...
            body{
               ...
               .nav{width: 100%;display:flex;font-size: 15px;}
    ...
    <body>
        ...
        <div class = "nav">
            <span style="margin-top:1%;margin-left: 2%;margin-right: 2%;">
            <a href = "home.jsp">Home</a>
            </span>
            <span style="margin-top:1%;margin-left: 2%;margin-right: 8%;">
      ...
      <!-- <div><center><h1 class="heading">STUDENT MANAGEMENT SYSTEM</h1> </center></div> -->
            ...
            <table class = "table" border= "3" style = "width: 75%;"
                ...
                %>
                        ...
                        <td style="width:3%;"><%= rno %></td>
                        <td style="word-wrap:break-word;"><%= fname %></td>
                        <td><%= lname %></td>
                        <td><%= address %></td>
                        <td><%= phn %></td>
                        <td><%= sem %></td>
